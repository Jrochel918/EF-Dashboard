        ...
        <div style={{ maxWidth: 440, margin: '0 auto', padding: '80px 24px' }}>
          ...
          {supabaseUser ? (
            ...
            <div style={{ marginBottom: 40 }}>
              <button
                onClick={() => { if (!privacyAccepted) { setShowPrivacy(true); return; } handleGoogleSignIn(); }}
                disabled={signingIn}
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, width: '100%', padding: '14px 20px', backgroundColor: '#000', color: '#fff', border: 'none', cursor: signingIn ? 'wait' : 'pointer', fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.04em', opacity: signingIn ? 0.6 : 1 }}>
                {!signingIn && (
